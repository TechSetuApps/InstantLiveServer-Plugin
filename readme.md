...
This plugin requires the **InstantWeb** app (v1.3.0 or above) to function. InstantWeb runs a local HTTP server on your Android device that serves your HTML, CSS, and JS files.

Download InstantWeb:
[APKPure — InstantWeb](https://apkpure.net/instantweb/app.techsetuapps.instantweb/)
...
2. Search for **InstantWeb LivePreviewer** → Install.
...
**Preview not loading?**
- Make sure InstantWeb is open and hosting
- Check the port matches in both apps (default: `7090`)
- Tap the reload button in the plugin panel

**CSS/JS not loading?**
- In InstantWeb, use **Add More Files** to select CSS/JS files alongside your HTML
