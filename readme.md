...
Super lightweight setup — InstantWeb app is only **5.83MB** to download and **~16.1MB** installed. No extra dependencies, no complex configuration.
...
This plugin requires the **InstantWeb** app (v1.2.0 or above) to function. InstantWeb runs a local HTTP server on your Android device that serves your HTML files.

<!-- UPDATE THIS LINK when InstantWeb v1.2.0 is published -->
Download InstantWeb:
[APKPure — InstantWeb](https://apkpure.net/instantweb/app.techsetuapps.instantweb/download)

---

## Installation Steps

**Step 1 — Set Up InstantWeb**

1. Download and install InstantWeb from the link above.
2. Open InstantWeb.
3. Tap **Select File** and choose any `.html` file from your device.
4. Tap **Start Hosting** — a short ad will play, then the server starts on `http://127.0.0.1:7090`.
...
3. Tap **Plugins**.
4. Search for **InstantWeb LivePreviewer**.
5. Tap **Install**.
...
2. Make sure InstantWeb is running and hosting your file.
3. Tap the floating **W** button on screen, or press **Ctrl + Shift + W**.
4. The live preview panel opens showing your page in real time.
5. Save your file — preview auto-reloads within 500ms.

> **Default port is 7090.** If you changed the port in InstantWeb Settings, update it in the plugin's address bar too.
